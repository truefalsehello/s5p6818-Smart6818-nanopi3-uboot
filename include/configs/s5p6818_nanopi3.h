...
#define CONFIG_DESIGNWARE_ETH           /*designware */
#define CONFIG_ETH_DESIGNWARE
#define CONFIG_PHY_REALTEK                      /*realtek*/
#define CONFIG_PHYLIB                           /*phy*/
...
#define CONFIG_ENV_CALLBACK_LIST_STATIC "ipaddr:ipaddr,serverip:serverip,"
